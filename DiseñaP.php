...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/EstiloDiseñaTuSombrero.css" />
</head>
<body style="background-color:#4C0324;">
    ...
    <section class="group group--color">
     ...
     <main class="main">
        <section class="group group--color">
            <div class="container container--flex">
                <div class="img1">
                    <img id= "color" src="img/Indiana/Frente/Indiana.png">
                </div>
                <div class="img2">
                    <img id= "designs" width="50%" src="img/Diseños/trans.png" class="dis">
                </div>
                <div class= "pos1">
    ...
    <script src="js/confimages.js"></script> 
