...
<body style="background-color:#4C0324;">
    ...
    <nav class="main-nav">
        <div class="container container--flex">
            ...
            <ul class="menu" id="menu">
                <li class="menu__item"><a href="IndexP.php" class="menu__link menu__link--select">Inicio</a></li>
    ...
    <section class="group main__about__description">
        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="img/Envios/Envio1.jpeg"></div>
                <div class="swiper-slide"><img src="img/Envios/Envio2.jpeg"></div>
                <div class="swiper-slide"><img src="img/Envios/Envio3.jpeg"></div>
                <div class="swiper-slide"><img src="img/Envios/Envio4.jpeg"></div>
                <div class="swiper-slide"><img src="img/Envios/Envio5.jpeg"></div>
                <div class="swiper-slide"><img src="img/Envios/Envio6.jpeg"></div>      
            </div>
    ...
    <section class="group main__about__description">
        <div class="container container--flex">
            ...
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src="img/Inicio/talla.jpeg"></div>
                    <div class="swiper-slide"><img src="img/Inicio/talla2.jpeg"></div>   
                </div>
                <div class="swiper-button-next"></div>
                <div class="swiper-button-prev"></div>
            </div>
    ...
    <section class="group main__about__description">
        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="img/Inicio/adaptacion.jpg"></div>
                <div class="swiper-slide"><img src="img/Inicio/adaptacion2.jpg"></div>
                <div class="swiper-slide"><img src="img/Inicio/adaptacion3.jpg"></div>
            </div>
            <div class="swiper-button-next"></div>
            <div class="swiper-button-prev"></div>
        </div>
